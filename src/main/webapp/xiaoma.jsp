...
<head>
    ...
    <link rel="stylesheet" href="${staticPath }/commons/css/index.css">
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="commons/img/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
                    <dl class="layui-nav-child">
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="commons/img/face.jpg" class="userAvatar"></a>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2017 驊驊龔頾</span>　　<a onclick="donation()" class="layui-btn layui-btn-danger layui-btn-sm">捐赠作者</a></p>
    </div>
</div>
...
<script src="${staticPath }/commons/js/index.js"></script>
<script src="${staticPath }/commons/js/cache.js"></script>
</body>
</html>